...
class AmenityService
{
    ...
    public function updateAmenity(Amenity $amenity, array $data)
    {
        ...
        $amenity = $this->amenityRepo->update($amenity->id, $data);

        if ($amenity) {
            return ApiResponse::success($amenity, __('amenity.updated_success'));
        }

        return ApiResponse::error(__('amenity.update_fail'), [], HttpStatusCode::BAD_REQUEST);
    }
